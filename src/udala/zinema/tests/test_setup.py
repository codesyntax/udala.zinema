...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        self.assertTrue(self.installer.is_product_installed("udala.zinema"))
    ...
    def test_browserlayer(self):
        ...
        self.assertIn(IUdalaZinemaLayer, utils.registered_layers())
...
class TestUninstall(unittest.TestCase):
    ...
    def test_product_uninstalled(self):
        ...
        self.assertFalse(self.installer.is_product_installed("udala.zinema"))
